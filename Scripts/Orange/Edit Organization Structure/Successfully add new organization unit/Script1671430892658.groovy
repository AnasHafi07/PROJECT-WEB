...
WebUI.setText(findTestObject('Object Repository/Orange/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'Testing')

WebUI.click(findTestObject('Object Repository/Orange/Page_OrangeHRM/button_Save'))

WebUI.click(findTestObject('Object Repository/Orange/Page_OrangeHRM/i_Testing_oxd-icon bi-trash-fill'))

WebUI.click(findTestObject('Object Repository/Orange/Page_OrangeHRM/button_Yes, Delete'))
